...
<head>
    ...
    <style>
        ...
        .error-page-body{padding:10px 0}
        .error-page-body p{font-size:14px;padding:5px 0;color:#666;line-height:25px}
...
<div class="error-page">
    <div class="error-page-container">
        <div class="error-page-main">
            ...
            {if $status==1:}
                <h3 style="color:#4288ce;"><strong>:)</strong>{$msg}</h3>
            {else:}
                <h3 style="color:#a94442;"><strong>:(</strong>{$msg}</h3>
            {/if}
