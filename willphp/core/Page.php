...
class Page
{
    ...
    private string $getVar; //页码$_GET变量
    private int $currentNum; //当前页码
    private int $offset; //limit开始数
    private array $options = ['home' => '首页', 'end' => '尾页', 'up' => '上一页', 'down' => '下一页', 'pre' => '上n页', 'next' => '下n页', 'header' => '条记录', 'unit' => '页', 'theme' => 0];
    ...
    public function getAttr(string $type = '')
    {
        ...
        $attr['page'] = $this->currentNum; //当前页码
